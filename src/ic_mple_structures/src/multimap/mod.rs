    ...
    M: Memory,
{
    ...
    pub fn iter_from_prev_key(&self, key: &(K1, K2)) -> StableMultimapIter<'_, K1, K2, V, M> {
        StableMultimapIter::new(self.0.iter_from_prev_key(key))
    }
}
...
mod test {
    ...
    #[test]
    fn iter_from_prev_key() {
        let mm = make_map();
        assert_eq!(
            mm.iter_from_prev_key(&(Array([0, 0]), Array([0, 0, 0])))
                .next(),
            None
        );
        assert_eq!(
            mm.iter_from_prev_key(&(Array([1, 2]), Array([0, 0, 0])))
                .next(),
            None
        );
        assert_eq!(
            mm.iter_from_prev_key(&(Array([1, 2]), Array([11, 12, 13])))
                .next(),
            None
        );
        assert_eq!(
            mm.iter_from_prev_key(&(Array([1, 2]), Array([15, 16, 17])))
                .next(),
            Some((
                Array([1, 2]),
                Array([11, 12, 13]),
        ...
        assert_eq!(
            mm.iter_from_prev_key(&(Array([10, 20]), Array([15, 16, 17])))
                .next(),
            Some((
                Array([1, 2]),
                Array([11, 12, 13]),
        ...
        assert_eq!(
            mm.iter_from_prev_key(&(Array([10, 20]), Array([21, 22, 23])))
                .next(),
            Some((
                Array([1, 2]),
                Array([11, 12, 13]),
        ...
        assert_eq!(
            mm.iter_from_prev_key(&(Array([10, 20]), Array([21, 22, 25])))
                .next(),
            Some((
                Array([10, 20]),
                Array([21, 22, 23]),
        ...
        assert_eq!(
            mm.iter_from_prev_key(&(Array([10, 21]), Array([0, 0, 0])))
                .next(),
            Some((
                Array([10, 20]),
                Array([21, 22, 23]),
